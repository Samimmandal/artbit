...
export default function ProductDetails() {
  ...
  return (
    <div className={`min-h-screen ${bg} ${text}`}>
      <header
        className={`border-b ${darkMode ? 'border-[#ffffff]/20' : 'border-[#000000]/15'} sticky top-0 ${bg} z-50`}
      >
          ...
          <div>
            <div
              className={`relative aspect-[3/4] w-full overflow-hidden ${imgBg} border ${
                darkMode ? 'border-[#ffffff]/15' : 'border-[#000000]/10'
              }`}
            ...
            >
              ...
              {product.tag && (
                <span className="absolute top-3 left-3 bg-[#000000] text-[#ffffff] text-[10px] font-mono uppercase px-2 py-1 z-10">
                  {product.tag}
                </span>
              )}
              {discountPct && (
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2 mb-6">
              <button
                ...
                className="flex-1 min-w-[120px] bg-[#000000] text-[#ffffff] py-3.5 font-mono text-xs uppercase tracking-wider disabled:opacity-40"
              >
                Buy Now
              </button>
              <button
                ...
                {coupons.map((c) => (
                  <div
                    ...
                    className={`text-sm py-1.5 border-b last:border-0 ${
                      darkMode ? 'border-[#ffffff]/10' : 'border-gray-200'
                    }`}
                  >
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className={`flex-1 border px-3 py-2 text-sm outline-none bg-transparent ${
                    darkMode ? 'border-[#ffffff]/30' : 'border-gray-300'
                  }`}
                />
                <button
                  type="button"
            ...
            <table className="w-full text-left text-xs font-mono">
              ...
              <tbody>
                {[
                  ...
                  <tr
                    key={row[0]}
                    className={`border-b ${darkMode ? 'border-[#ffffff]/10' : 'border-gray-200'}`}
                  >
                    {row.map((c, i) => (
              ...
              {appliedCoupon ? (
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    type="button"
                    onClick={applyCoupon}
                    className="bg-[#000000] text-white px-3 py-1.5 text-xs font-mono uppercase"
                  >
                    Apply
                  </button>
                </div>
            ...
            <form className="space-y-4">
              ...
              <div className="grid grid-cols-1 gap-2 pt-2">
                ...
                >
                  {submitting
                    ? 'Processing...'
                    : `Pay Online ₹${orderTotal.toLocaleString('en-IN')}`}
                </button>
                <button
                  type="button"
                  disabled={submitting}
